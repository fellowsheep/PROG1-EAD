...
public class Main {  //Classe gerenciadora da aplicação
    ...
    private static void executar() {
        ...
        while (opcao != 6)
        {
            ...
            System.out.println("1 - Mago: lançar magia");
            System.out.println("2 - Mago: equipar item");
            System.out.println("3 - Mago: lançar magia forte");
            System.out.println("4 - Mago: desequipar item");
            System.out.println("5 - Mago: morrer");
